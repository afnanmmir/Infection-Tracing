...
In addition, the simulation results are shown in Figure \ref{fig:simulation_results}. The simulation results show that the number of infected people initially increases, but then decreases significant and approached 0. Whereas the number of recovered people exhibit the opposite behavior. This makes sense since the infected people recover after seven days can no longer become susptible again. Also, the number of susceptible people decreases over time, which makes sense since they are getting infected and recovering. The maximum number of infected people on any given day is about 11,500 and the total number of people infected over the simulation is about 14,300.
...
For the milestore, Afnan generated and analyzed the 5-Day Contact Network and performed static link prediction on it. Jay created and analyzed the Temporal Contact Networks and ran the SIR simulation on them.
